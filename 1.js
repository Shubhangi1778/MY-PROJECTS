var productList = [
  ...
  for(var i=0;i<productList.length;i++){
      ...
      craeteCard(productList[i].name,productList[i].preview,productList[i].brand,productList[i].price,productList[i].isAccessory);
  }
/*<div class="card">
  ...
  function craeteCard(name,preview,brand,price,isAccessory){
    ...
    var producDesc=document.createElement("div");
    producDesc.className="cont-desc";

    var productName=document.createElement("h3");
    productName.className="product-name";
    productName.innerText=name;
    producDesc.appendChild(productName);

    var productBrand=document.createElement("h4")
    productBrand.className="product-brand";
    productBrand.innerText=brand;
    producDesc.appendChild(productBrand);

    placeCard.appendChild(producDesc);

    if(isAccessory==true){
        var lastcardplace=document.getElementById("accessories");
        lastcardplace.appendChild(placeCard);
        }
    else{
        var lastcardplaceacc=document.getElementById("clothing");
        lastcardplaceacc.appendChild(placeCard);
    }
  }